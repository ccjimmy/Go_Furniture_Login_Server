...
const ( //协议类型
	...
	INVITE_TO_GROUP_CREQ         = 44 //申请邀请一个人入群
	INVITE_TO_GROUP_SRES         = 45 //申请邀请一个人入群的响应
	BE_INVITE_TO_GROUP_SRES      = 46 //被邀请加入一个群
	INVITE_PROCESS_CREQ          = 47 //被邀请人的操作（同意或拒绝）
	INVITE_PROCESS_SRES          = 48 //被邀请人的操作的响应
	OTHER_PROCESS_OF_INVITE_SRES = 49 //邀请别人后，被邀请人的操作结果
